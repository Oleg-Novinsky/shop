...
<section>
    <div class="container">
                ...
                <div class="features_items"><!--features_items-->
                    ...
                    <?php foreach ($categoryProducts as $sliderItem): ?>
                    <div class="col-sm-3 col-xs-12 col-xs-4">
                            <div class="item">
...
<a href="#" class="btn btn-default add-to-cart" data-id="<?php echo $sliderItem['id']; ?>"><i class="fa fa-shopping-cart">
