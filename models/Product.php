...
class Product
{
    ...
    public static function getRecommendedProducts()
    {
     ...
     public static function getSliderProducts()
    {
        // Соединение с БД
        $db = Db::getConnection();

        // Получение и возврат результатов
        $result = $db->query('SELECT id FROM slider ');
        $i = 0;
        $productsList = array();
        while ($row = $result->fetch()) {
            $productsList[$i]['id'] = $row['id'];
       ...
       public static function getPreview($id)
    {
        ...
        // Путь к папке с товарами
        $path = '/upload/images/products-preview/';
        ...
        public static function getSlides($id)
    {
        // Название изображения-пустышки
        $noImage = 'no-image.jpg';
     ...
     public static function getReview()
    {
        ...
        // Получение и возврат результатов
        $result = $db->query('SELECT id, name, review FROM review '
        ...
        while ($row = $result->fetch()) {
            ...
            $reviewList[$i]['review'] = $row['review'];
